...
const errors: Record<string, string> = {
  diarization_model_missing: 'Разделение по участникам ещё не настроено. Установите локальные модели по инструкции запуска и повторите попытку.',
  diarization_failed: 'Не удалось разделить голоса в записи. Повторите обработку или проверьте локальные модели.',
